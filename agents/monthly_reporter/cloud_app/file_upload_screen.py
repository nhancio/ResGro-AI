...
def display_file_upload_screen():
    ...
    # Custom CSS for Resgro-branded upload screen
    st.markdown("""<style>
.section-header {
    font-size: 1.15rem;
    font-weight: 700;
...
.step-number {
    ...
    # Main header – Resgro branded
    st.markdown("""
    <div style="display:flex; align-items:center; gap:0.75rem; margin-bottom:0.25rem;">
        <span style="font-size:2rem; font-weight:800; color:#E8792B; letter-spacing:-0.03em;">Resgro</span>
    ...
    <div style="background:#F8F6F3; border:1px solid #EEEBE6; border-radius:10px; padding:1.2rem 1.5rem; margin:0.75rem 0 1rem;">
        ...
        <ol style="margin:0; padding-left:1.2rem; color:#444; font-size:0.88rem; line-height:1.7;">
            ...
            <li><strong>Run Analysis</strong> — The dashboard shows Pre vs Post and Year-over-Year comparisons for Sales, Orders, Payouts, New Customers, Profitability, and Marketing (Corporate vs Resgro) across all stores.</li>
        </ol>
        <div style="margin-top:0.6rem; font-size:0.82rem; color:#7A7267;">
            <strong>What you'll see:</strong> KPI cards · Combined &amp; per-platform summary tables · Store-level breakdowns · Corporate vs Resgro marketing · Time-slot analysis · Insights · Excel &amp; Google Drive exports
        </div>
    </div>
    """, unsafe_allow_html=True)
