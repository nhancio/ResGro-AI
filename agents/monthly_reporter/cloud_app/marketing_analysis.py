"""Marketing analysis functions for Corporate vs Resgro tables"""
    ...
    for marketing_dir in marketing_dirs:
        ...
        try:
            ...
            if "Date" in df.columns or _resolve_date_column(df) is not None:
                ...
                st.warning(
                    f"No Date column in {promotion_file.name}; skipping Corporate vs Resgro for this file."
                )
                continue
    ...
    for marketing_dir in marketing_dirs:
        ...
        try:
            ...
            if "Date" in df.columns or _resolve_date_column(df) is not None:
                ...
                st.warning(
                    f"No Date column in {sponsored_file.name}; skipping Corporate vs Resgro for this file."
                )
                continue
...
def create_corporate_vs_todc_table(
    ...
    """
    Create Corporate vs Resgro table combining promotion and sponsored listing data.
