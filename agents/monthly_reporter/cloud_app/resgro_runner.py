"""
Headless runner for App2.0 analytics (ported Streamlit app) — used by ResgroAI API + dashboard.
    ...
    *,
    ...
    try:
        ...
        try:
            ...
            summary_text = (
                f"Resgro report ready for operator: {operator_name or 'default'} | "
                f"Sales Pre: {sales_pre} | Sales Post: {sales_post} | Growth: {growth_pct}%"
            )
        except Exception:
            summary_text = "Resgro report ready."
