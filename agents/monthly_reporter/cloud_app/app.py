...
def main():
    ...
    with st.sidebar:
        ...
        <div style="padding:1.2rem 0.5rem 0.5rem; text-align:center;">
            <span style="font-size:1.4rem; font-weight:800; color:#E8792B; letter-spacing:-0.02em;">Resgro</span>
    ...
    # Get Corporate vs Resgro tables
    ...
    # 7. Corporate vs Resgro Table
    st.markdown('<div class="todc-section-header">Corporate vs Resgro Marketing</div>', unsafe_allow_html=True)
    if corporate_todc_table is not None and not corporate_todc_table.empty:
        st.subheader("Combined: Corporate vs Resgro")
        ...
        # Rename index for display (False = Corporate, True = Resgro)
