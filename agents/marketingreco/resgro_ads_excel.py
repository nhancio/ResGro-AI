"""
Build ResgroAI — Ads upload rows from MarketingReco ads_plan.slot_table.
...
def resgro_ads_upload_rows(ads_plan: dict) -> list[dict]:
    """
    One row per store for Resgro Ads upload:
        ...
        out.append(
            {
                ...
                "bid_strategy": 3,
                "budget": budget,
                "campaign_name": f"Resgro-{sid}-Ads",
            }
        )
    return out
